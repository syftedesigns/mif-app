...
$(window).on('load',function() { 	
	...
	$('body').prepend('<div class="page-change-preloader preloader-dark"><div id="preload-spinner"></div></div>');
});
...
$(document).ready(function(){      
	...
	function init_template(){	
		...
		$('.article-clone .article-header').append('<span class="article-back"><i class="fa fa-angle-left"></i> Atrás</span>');
...
function toggleSubmenu(){
	if($(".subheader").hasClass('topped')){
		$(".subheader").removeClass('topped');
		$("body").removeClass('menucollapsed');
	}else{
		$(".subheader").addClass('topped');
		$("body").addClass('menucollapsed');		
	}
}

window.onload = function(){
	var act = document.documentElement.scrollTop;
	var act2 = document.body.scrollTop;
	var act3 = document.getElementById('page-transitions').scrollTop;
	var onan = false;
	window.onscroll = function() {
		var ac = document.documentElement.scrollTop;
		var ac2 = document.body.scrollTop;
		var ac3 = document.getElementById('page-transitions').scrollTop;
		
		if(!onan){		
			onan = true;
			if(ac>act || ac2>act2 || ac3>act3){
				$(".subheader").addClass('topped');
				$("body").addClass('menucollapsed')
			}else{
				$(".subheader").removeClass('topped');
